...
export default function Footer(){
   return(
    <div className="bg-gray pt-3 px-4">
        <h1 className="text-primary-orange text-lg font-bold">Girolux Materiais Elétricos</h1>
         <p className="text-white">Av. Weimar Gonçalves Torres, 2692 - Centro,</p>
         <p className="text-white">Dourados - MS, 79800-024</p>
